...
set_secure_file_permissions() {
        ...
        # File permission hardening for system files
...
# Currently running this in the pentest module. So commenting out for now
...
#}
#
# Function to apply kernel parameter improvements
...
# Enhance PAM configuration
enhance_pam_configuration() {
...
# set system security defaults
set_system_security_defaults() {
        # Set umask
...
# Main function to apply Lynis score improvements
